from primary_replica_replication import (primary_data, replica1_data, replica2_data, replication_log, 
                                         write_to_primary, replicate_to_replicas, read_from_primary, read_from_replica)
